...
class DeleteClient {
    deleteById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const existingClient = yield client_service_1.clientsDbService.deleteClientById(clientId);
            if (!existingClient) {
                throw new badRequestError_1.BadRequestError('Client does not exist');
            }
            res.status(http_status_codes_1.default.OK).json({ message: 'Client has been deleted' });
        });
    }
}
